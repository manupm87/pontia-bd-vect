...
def build_cells() -> list[NotebookNode]:
    cells: list[NotebookNode] = [
        markdown(
            ...
            **embedding**: un vector de números reales (aquí, 384 dimensiones) en un
            espacio donde la cercanía geométrica se corresponde con la cercanía
            semántica. Buscar deja de ser «¿qué títulos contienen estas palabras?» y
